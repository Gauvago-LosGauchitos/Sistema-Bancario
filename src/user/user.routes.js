...
import {  deleteU, getLoggedUser, listAdmin, listUsers, login, registerAd, registerC, testU, updateUserAd, updateUserSelf, findUserByUsername, uploadImage, findUserAndAccountByUsername, searchUsersByUsername } from './user.controller.js';
...
api.post('/findUserAndAccountByUsername', [validateJwt], findUserAndAccountByUsername)
api.post('/search', searchUsersByUsername);
